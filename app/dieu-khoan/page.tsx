  ...
  return (
    <Section bg="cream" spacing="md">
      <Container size="narrow">
        ...
        <h1 className="mt-3 font-heading text-headline-lg text-navy mb-2">Điều khoản sử dụng</h1>
        <p className="text-label-caps text-navy/60 mb-10">Cập nhật lần cuối: 27/04/2026</p>

        {/* Long-form prose — container-narrow, token typography */}
        <div className="space-y-6">
          ...
          <h2 className="font-heading text-headline-sm text-navy mt-8">1. Quyền sở hữu trí tuệ</h2>
          ...
          <h2 className="font-heading text-headline-sm text-navy mt-8">4. Hành vi không được phép</h2>
          <p className="text-body-md text-navy/80 leading-relaxed">Khi sử dụng website, bạn không được:</p>
          <ul className="list-disc ml-6 space-y-1.5 text-body-md text-navy/80">
          ...
          <h2 className="font-heading text-headline-sm text-navy mt-8">5. Giới hạn trách nhiệm</h2>
          <p className="text-body-md text-navy/80 leading-relaxed">
          ...
          <h2 className="font-heading text-headline-sm text-navy mt-8">6. Luật áp dụng</h2>
          <p className="text-body-md text-navy/80 leading-relaxed">
          ...
          <h2 className="font-heading text-headline-sm text-navy mt-8">7. Thay đổi điều khoản</h2>
          <p className="text-body-md text-navy/80 leading-relaxed">
          ...
          <h2 className="font-heading text-headline-sm text-navy mt-8">8. Liên hệ</h2>
          <p className="text-body-md text-navy/80 leading-relaxed">
