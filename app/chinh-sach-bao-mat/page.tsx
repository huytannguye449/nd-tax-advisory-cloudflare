  ...
  return (
    <Section bg="cream" spacing="md">
      <Container size="md">
        ...
        <h1 className="mt-3 text-3xl md:text-4xl font-bold mb-2">Chính sách bảo mật</h1>
        ...
        <div className="prose prose-navy max-w-none space-y-6">
          ...
          <h2 className="text-xl font-bold mt-8">1. Dữ liệu chúng tôi thu thập</h2>
          ...
          <h2 className="text-xl font-bold mt-8">2. Mục đích sử dụng</h2>
          <ul className="list-disc ml-6 space-y-1 text-navy/80">
          ...
          <h2 className="text-xl font-bold mt-8">3. Lưu trữ và bảo mật</h2>
          <p>
          ...
          <h2 className="text-xl font-bold mt-8">4. Chia sẻ với bên thứ ba</h2>
          <p>
          ...
          <h2 className="text-xl font-bold mt-8">5. Quyền của bạn</h2>
          <p>Bạn có các quyền sau với dữ liệu cá nhân của mình:</p>
          <ul className="list-disc ml-6 space-y-1 text-navy/80">
          ...
          <h2 className="text-xl font-bold mt-8">7. Liên hệ</h2>
          <p>
            Mọi thắc mắc về chính sách này, vui lòng liên hệ:
          </p>
          <ul className="list-none space-y-1 text-navy/80">
            <li>Email: <a href={`mailto:${SITE.email}`} className="text-gold-700 underline">{SITE.email}</a></li>
            <li>Điện thoại: <a href={`tel:${SITE.phone}`} className="text-gold-700 underline">{SITE.phone}</a></li>
