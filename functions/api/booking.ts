...
export const onRequestPost: PagesFunction<Env> = async ({ request, env }) => {
  try {
    ...
    const wrap = (body: string) => `<!DOCTYPE html><html><body style="background:#FAF7F0;font-family:system-ui;padding:32px"><div style="max-width:600px;margin:0 auto;background:#fff;border-radius:8px;padding:32px">${body}</div></body></html>`;
